            ...
            <View className="mb-8">
                ...
                <View className="flex-row gap-3">
                    <Pressable
                        ...
                        className={`flex-1 py-3 px-4 rounded-xl border-2 ${tempTheme === "navy"
                    ...
                    <Pressable
                        ...
                        className={`flex-1 py-3 px-4 rounded-xl border-2 ${tempTheme === "green"
                            ? "bg-primary/20 border-primary"
                            : "bg-transparent border-gray-600"
                            } items-center`}
                    >
                    ...
                    {([
                        ...
                        return (
                            <Pressable
                                ...
                                className={`py-2 px-3 rounded-lg border ${isSelected
