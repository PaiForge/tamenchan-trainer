...
export default function TrainingScreen() {
    ...
    const startNewGameFlow = () => {
        ...
        // 2x Penchan
        queue.push({ patternId: "1112", requirePenchan: true, requireInterference: false });
        queue.push({ patternId: "1112", requirePenchan: true, requireInterference: false });
        // 2x Interference
        queue.push({ patternId: "1112", requirePenchan: false, requireInterference: true });
        queue.push({ patternId: "1112", requirePenchan: false, requireInterference: true });
        // 6x Normal
        for (let i = 0; i < 6; i++) {
            queue.push({ patternId: "1112", requirePenchan: false, requireInterference: false });
        }
    ...
    const loadQuestion = (config: ProblemConfig) => {
